...
{
    public partial class FormReportHDN : Form
    {
        public FormReportHDN()
        {
            InitializeComponent();
        }
        ...
        private void btnTao_Click(object sender, EventArgs e)
        {
            ...
            var salesData = dataProcess.GetBuyData(startDate, endDate);
            ...
            reportViewer1.LocalReport.ReportEmbeddedResource = "BTLBinh.Report.RpHoaDonNhap.HoaDonNhap.rdlc";
